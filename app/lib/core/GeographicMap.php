 ...
 */
 ...
 class GeographicMap {
	...
	# -------------------------------------------------------------------
 	 ...
 	 *			contentView - view to use to render info balloon content shown when map item is clicked; specify the view filename with path relative to the main view directory (eg. "Splash/splash_html.php"); the view will be passed a single variable, "data", containing an array of data to be displayed. The view will be used once for each item to be displayed in the balloon. If there are multiple items at the same map coordinates, they will be merged into a single balloon containing multiple instances of this view.
