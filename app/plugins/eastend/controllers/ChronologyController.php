	...
	require_once(__CA_MODELS_DIR__."/ca_entities.php");
 	...
 	class ChronologyController extends BaseSearchController {
 		...
 		protected $opa_periods = array(
			...
			7 => array("start" =>2000, "end" => 2010, "label" => "2000 - 2010", "displayAllYears" => 1),
			8 => array("start" =>2010, "end" => 2060, "label" => "2010 - present", "displayAllYears" => 1)
		);
		
		private $opa_access_values;
		private $opn_default_period = 4;
