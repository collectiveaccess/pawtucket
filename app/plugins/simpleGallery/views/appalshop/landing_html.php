 ...
 */
	...
	$va_first_items_from_sets = $t_set->getFirstItemsFromSets(array_keys($va_set_list), array("version" => "widepreview", "checkAccess" => $va_access_values));
 			
	$va_set_descriptions					= $this->getVar('set_descriptions');
?>
<div id="galleryLanding">
	<H1><?php print _t("Special Projects"); ?></H1>
	<div class="textContent">
<?php
	print $this->render('appalshop/intro_text_html.php');
?>
	</div>
<?php
