...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<title>Moving Images | Northeast Historic Film</title>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
...
//--><!]]>
	...
	<link href="<?php print $this->request->getBaseUrlPath(true); ?>/js/videojs/video-js.css" rel="stylesheet" type="text/css" />
...
?>
	...
	<li class="leaf <?php print ($vs_section == "CollectionsList") ? "active-trail" : ""; ?>"><?php print caNavLink($this->request, _t('Collections'), ($vs_section == "CollectionsList") ? "active" : "", '', 'Browse', 'CollectionsList'); ?></li>
...
<li id="store" class="leaf"><div class="left"></div><div class="right"></div><a href="http://67.20.74.44/store/" title="">Store</a></li>
...
<?php
	if((!in_array($this->request->getController(), array("Browse"))) || ($this->request->getController() == "Browse" && in_array($this->request->getAction(), array("GenreList", "PlaceList", "SubjectList", "DecadeList", "PeopleList", "clearAndAddCriteria", "CollectionsList", "HiddenCollectionsList")))){
?>
