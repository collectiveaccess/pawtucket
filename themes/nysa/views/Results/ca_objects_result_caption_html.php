...
<?php
	...
	if($this->getVar('caption_title')){
		$vs_caption .= (unicode_strlen($this->getVar('caption_title')) > 70) ? preg_replace('![^A-Za-z0-9]+$!', '', substr(strip_tags($this->getVar('caption_title')), 0, 67)).'...' : $this->getVar('caption_title');
		$vs_caption .= "<br/>";
	}
