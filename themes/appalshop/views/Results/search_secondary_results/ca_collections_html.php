...
<?php
					...
					while($qr_collections->nextHit()) {
						...
						if ($vb_link_to_collection_detail) {
							if($qr_collections->get("type_id") == 132){
								# collections link to finding aid
								print caNavLink($this->request, $vs_name, '', 'FindingAids', 'List', 'Index', array('table' => 'ca_collections', 'collection_id' => $qr_collections->get('collection_id'), 'l' => strtolower(mb_substr($vs_name, 0, 1))));
							}else{
