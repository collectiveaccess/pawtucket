...
<div id="searchToolsBox">
		<div class="bg">
			<a href='#' id='hideTools' onclick='$("#searchToolsBox").slideUp(250); $("#searchRefineBox").slideDown(1); $("#showTools").slideDown(1); jQuery("input.addItemToSetControl").hide(); return false;'><?php print _t("Hide"); ?> <img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/arrow_right_gray.gif" width="9" height="10" border="0"></a>
<?php
