...
?>
			...
			<div class="quickLinkItem">
				...
				<table cellpadding="0" cellspacing="0"><tr><td valign="middle" align="center"><?php print caNavLink($this->request, (($this->getVar("user_favorites_is_random")) ? $this->getVar("random_object_thumbnail") : $this->getVar("user_favorites_thumbnail")), '', 'Detail', 'Object', 'Index', array('object_id' => (($this->getVar("user_favorites_is_random")) ? $this->getVar('random_object_id') : $this->getVar('user_favorites_id')))); ?></td></tr></table>
			</div>
			<div class="quickLinkItem">
