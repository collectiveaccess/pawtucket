...
?>
				...
				<div style="display:none;" id="sendPics">
					...
					Sie können uns Ihre Bilder in jedem gängigen Foto-, Film- und Videoformat zuschicken. Bitte füllen Sie zu jedem Film, Video oder Foto unseren Fragebogen <a href="<?php print $this->request->getThemeUrlPath(); ?>/graphics/pdf/foto_ia.pdf">Foto</a> oder <a href="<?php print $this->request->getThemeUrlPath(); ?>/graphics/pdf/film_ia.pdf">Film/Video</a> aus. Bitte vergessen Sie nicht, das <a href="<?php print $this->request->getThemeUrlPath(); ?>/graphics/pdf/Teilnahmeformular_CC.pdf">Teilnahmeformular</a> zu unterschreiben.
